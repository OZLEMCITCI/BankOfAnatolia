    ...
    return (
        <div id="package" className="pricing-area">
                    ...
                    <div className="col-lg-4 col-md-6">
                        ...
                        <div className="single-price text-center">
                            ...
                            <ul className="pricing-list">
                                <li><Link to="/services">Maximun Deposit $1000</Link></li>
                                <li><Link to="/services">Minimum Deposit $10000</Link></li>
                                <li><Link to="/services">Up to 5 User Available</Link></li>
                                <li><Link to="/services">Free Internet Banking</Link></li>
                                <li><Link to="/services" className="btn btn-blue">Buy Now</Link></li>
                            </ul>
            ...
            <div className="single-price text-center">
              ...
              <ul className="pricing-list">
                <li>
                  <Link to={"/services"}>Miximum Deposit $500</Link>
                </li>
                <li>
                  <Link to={"/services"}>Minimum Deposit $20000</Link>
                </li>
                <li>
            ...
            <div className="single-price text-center">
              ...
              <ul className="pricing-list">
                <li>
                  <Link to={"/services"}>Miximum Deposit $0</Link>
                </li>
                <li>
                  <Link to={"/services"}>Minimum Deposit $50000</Link>
                </li>
                <li>
